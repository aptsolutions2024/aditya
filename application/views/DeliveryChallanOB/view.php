...
<head>
    ...
    <title>View Delivery Challan Opening Bal | Aditya</title>
                ...
                <div class="content__wrap">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo base_url('viewOBDeliveryC');?>">Delivery Challan Opening Bal.</a></li>
                ...
                <div class="content__wrap">
                    <div class="card mb-3">
                        <div class="card-body">
                           ...
                           <div class="row">
                            <h2 style="width: 80%;">Delivery Challan Opening Bal.      :- <?=$_SESSION['branch_name']; ?></h2>
                             
                            <div class="mb-3" style="float: right;width: 20%;">
                                 <a href="<?php echo base_url('addOBDeliveryC');?>"><button type="button" class="btn btn-secondary" style="float: right;">Add DC Opening Bal</button></a>
                             </div>
                            </div>
                                 
                                <?php echo form_open('/viewOBDeliveryC', array('autocomplete' => 'off','class' => 'row g-3')); ?>
                            ...
                            <table id="example" class="display" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <a class="btn btn-icon btn-sm btn-primary btn-hover" href="<?php echo base_url('addOBDeliveryC');?>?ID=<?php echo base64_encode($value['id']); ?>"><i class="demo-pli-pen-5 fs-5"></i></a>
