...
<head>
    ...
    <title>Parts Movement Print | Aditya</title>
        ...
        <section id="content" class="content">
                ...
                <div class="content__wrap">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="<?php echo base_url();?>PartsMovement">Parts Movement</a> </li>
                        </ol>
                    </nav>
                    <!-- END : Breadcrumb -->
            ...
            <div class="content__boxed">
                <div class="content__wrap">
                    ...
                    <h2 class="mb-3 btnprnt">Parts Movement Print
                    </h2>
                                    ...
                                    <div class="card-body">
                                      ...
                                      <div class="col-md-4 btnprnt">
                                       ...
                                       // for($i=1;$i<=2;$i++){
                                        ?>
                                           <div class="pagebreak">
                                      <table style="width: 100%;" class=" parentable" id="originalCopy">
                                          <tr>
                                             ...
                                             <b>PARTS MOVEMENT ID</b> : <?php   if(!empty($getPartMovement)){ echo $getPartMovement['id'];   } ?>
                                              </td>
                                              </tr>
                                            ...
                                            <tr>
                                              ...
                                              $grand_total=0;
                                              $sr=1;
                                             // echo "<pre>";print_r($getPartMovement);echo "</pre>";
                                              if(!empty($getPartMovement)){    
                                                $pdata = $this->getQueryModel->getPartBypartid($getPartMovement['part_id']);
                                                $Odata = $this->getQueryModel->getOperation($getPartMovement['op_id']);
                                                $fdata = $this->getQueryModel->getBranchbyId($getPartMovement['from_branch_id']);
                                                $tdata = $this->getQueryModel->getBranchbyId($getPartMovement['to_branch_id']);                ?>
                                                
                                                <tr>
                                                <td> <?=$sr;?></td>
                                                <td ><?=($getPartMovement['date'])?date("d-m-Y",strtotime($getPartMovement['date'])):"";?></td>
                                                <td ><?=$pdata['partno']." - ".$pdata['name'];?></td>
                                                <td ><?=$Odata['name'];?></td>
                                                <td ><?=$fdata['name'];?></td>
                                                <td ><?=$tdata['name'];?></td>
                                                <td ><?=$getPartMovement['qty'];?></td>
                                                </tr>
                                                
                                               <?php 
                                               $grand_total=$grand_total+$getPartMovement['qty'];
                                                } ?>
                                            ...
                                            <td colspan='4'>PREPARED BY : Q.A Mngr</td>
