                ...
                <div class="content__wrap">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo base_url('viewToolRepair');?>">Tool Repair Details</a></li>
                        ...
                        <div class="card-body">
                           ...
                           <div class="row">
                            ...
                            <div class="mb-3" style="float: right;width: 20%;">
                                 <a href="<?php echo base_url('addToolRepair');?>"><button type="button" class="btn btn-secondary" style="float: right;">Add Tool Repair Details</button></a>
                             </div>
                            </div>
                                 
                                <?php echo form_open('/viewToolRepair', array('autocomplete' => 'off','class' => 'row g-3')); ?>
