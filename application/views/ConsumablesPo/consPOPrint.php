        ...
        <section id="content" class="content">
                ...
                <div class="content__wrap">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="<?php echo base_url('ConsumablesPO');?>">Consumables PO Print</a></li>
                        </ol>
                    </nav>
                    <!-- END : Breadcrumb -->
            ...
            <div class="content__boxed">
                <div class="content__wrap">
                    ...
                    <h2 class="mb-3 btnprnt">Consumables PO Print
                    </h2>
                                      ...
                                      <table style="width: 100%;" class="parentable">
                                             <tr>
                                              ...
                                              <span style="font-size: 20px;font-weight: 600;"><?php echo $companyDetails['name'];?> </span><BR>
                                                ...
                                                <span style="float: right;text-transform: uppercase;"><span style="font-weight: 600;" >
                                        ...
                                        <td style="" colspan="4">
                                            ...
                                            <td style="text-align: center;" colspan="3">
                                                P.O. No.:- FEL/C/ <?php echo $getOtherpo['id'];?>
                                                <br>
                                           ...
                                           <tr>
                                             ...
                                             <span style="float: left;text-transform: uppercase;"><span style="font-weight: 600;">
                                                GST NUMBER: </span><?php echo $supplierD['gst_no'];?>
                                                </span>  
                                                  </td>
                                                 <td style="text-align: center;" colspan="3">
                                                       </td>
                                            ...
                                            <tr>
                                              ...
                                              foreach($getOtherpoDetails as $podetails){ 
                                                ...
                                                <tr>
                                                <td> <?=$sr;?> </td>
                                                <td><?php echo $podetails['description']."</br>".$podetails['remarks'];?></td>
                                            ...
                                            <tr>
                                                <td  colspan="7">
                                               <span style="font-weight: 600;">Remarks :- </span><?php echo $getOtherpo['remarks'];?>
                                                </td>
                                              
                                            </tr>
                                              <tr>
                                                <td  colspan="7">
                                               <span style="font-weight: 600;">Payment Terms :- </span><?php echo $getOtherpo['payment_terms'];?>
                                                </td>
