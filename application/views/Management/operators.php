...
<head>
    ...
    <title>View Operators | Aditya</title>
                ...
                <div class="content__wrap">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo base_url('Operators') ?>">Operators</a></li>
            ...
            <div class="content__boxed">
                <div class="content__wrap">
                    <div class="card mb-3">
                        <div class="card-body">
                            <div class="row">
                            <h2 style="width: 80%;">Operators</h2>
                            <div class="mb-3" style="float: right;width: 20%;">
                                 <a href="<?php echo base_url('addOperators');?>"><button type="button" class="btn btn-secondary" style="float:right;">Add Operators</button></a>
                             </div>
                             </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                       <td class="text-center text-nowrap">
                                        <a class="btn btn-icon btn-sm btn-primary btn-hover" href="<?= base_url(); ?>/addOperators?ID=<?php echo base64_encode($value['id']); ?>"><i class="demo-pli-pen-5 fs-5"></i></a>
