...
<head>
    ...
    <title>View DC Operation RCIR | Aditya</title>
            ...
            <div class="content__boxed">
                <div class="content__wrap">
                    <div class="card mb-3">
                        <div class="card-body">
                            <div class="row">
                            <h2 style="width: 80%;">DC Operation RCIR</h2>
                            <div class="mb-3" style="float: right;width: 20%;">
                                 <a href="<?php echo base_url('addDCOperation');?>"><button type="button" class="btn btn-secondary" style="float: right;">Add RCIR</button></a>
                             </div>
                             </div>
                                <?php echo form_open('/viewDCOperation', array('autocomplete' => 'off','class' => 'row g-3')); ?>
                            ...
                            <table id="example" class="display" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <a class="btn btn-icon btn-sm btn-primary btn-hover" href="<?php echo base_url('addDCOperation');?>?ID=<?php echo base64_encode($value['id']); ?>"><i class="demo-pli-pen-5 fs-5"></i></a>
                                        ...
                                        <td style="text-transform: uppercase"><?=date("d-m-Y",strtotime($value['challan_date']));?></td>
