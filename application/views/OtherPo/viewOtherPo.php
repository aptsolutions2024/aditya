...
<head>
    ...
    <title>View Parts Purchase Order | Aditya</title>
                        ...
                        <div class="card-body">
                           ...
                           <div class="row">
                            ...
                            <div class="mb-3" style="float: right;width: 20%;">
                                 <a href="<?php echo base_url('addOtherPo');?>"><button type="button" class="btn btn-secondary" style="float: right;">Add Part Po</button></a>
                             </div>
                            </div>
                            ...
                            <table id="example" class="display" style="width:100%">
                                ...
                                <tbody>
                                    <?php 
                                        $count=0;
                                        foreach ($getOtherPo as $key => $value) { 
                                    ...
                                    <tr>
                                        ...
                                        <a class="btn btn-icon btn-sm btn-primary btn-hover" href="<?php echo base_url('addOtherPo');?>?ID=<?php echo base64_encode($value['id']); ?>"><i class="demo-pli-pen-5 fs-5"></i></a>
                                        <!--<a class="btn btn-icon btn-sm btn-danger btn-hover" -->
                                        <!--onclick="deleteRecord('<?=$value['id'];?>');"><i class="demo-pli-trash fs-5"></i></a>-->
                                          <a class="btn btn-icon btn-sm btn-danger btn-hover" href="<?php echo base_url('partPOPrint');?>?ID=<?php echo base64_encode($value['id']);?>"><span><i class="demo-pli-printer" aria-hidden="true" style="font-size: 20px;"></i></span></a>       
                                        </td>
                                        <td ><?=$value['id'];?></td>
