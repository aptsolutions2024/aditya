...
<head>
    ...
    <title>View Part Stock Details Revision | Aditya</title>
                ...
                <div class="content__wrap">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo base_url('PartStockDetailsRevision');?>">Parts Stock Details</a></li>
                ...
                <div class="content__wrap">
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <?php echo form_open('/PartStockDetailsRevision', array('autocomplete' => 'off','class' => 'row g-3','id' => 'formSch')); ?>
                                   <!--<div class="col-md-2">-->
                            ...
                            <table class="table table_stripped"  style="text-align:center;">
                               ...
                               <div style="overflow: auto;display:none;">
                                 <table class="table" style="width:100%" id="example2">
                                   ...
                                   <?php  
                                   $finalstock=0;
                                 // print_r($partStockSummary03_04_24);
                                 foreach ($partStockSummary03_04_24 as $key1 => $value1) { 
