...
<head>
    ...
    <title>DPR Deleted Entries| Period From Date: <?php echo date('d-m-Y',strtotime(set_value('schedule_from_date')));?> To  <?php echo date('d-m-Y',strtotime(set_value('schedule_to_date')));?></title>
        ...
        <section id="content" class="content">
                ...
                <div class="content__wrap">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo base_url('DPRDeletedEntries');?>">DPR Deleted Entries Report</a></li>
            ...
            <div class="content__boxed">
                <div class="content__wrap">
                    <div class="card mb-3">
                        <div class="card-body">
                            <?php echo form_open('/DPRDeletedEntries', array('autocomplete' => 'off','class' => 'row g-3','id' => 'formSch')); ?>
                            ...
                            <?php 
                            $count=0;
                               foreach($getDprDeletedEntries as $res1){
                                 $count++;
                                 $delete_remark = explode("- DELREM - ",$res1['remarks']);
                            ?>
                                    
                                <tr>
                                    <td><?=$count;?></td>
                                    <td><?= $res1['id']; ?></td>
                                    <td><?=date('d-m-Y',strtotime($res1['dpr_date']));?></td> 
                                    <td><?=$res1['partno'].' - '.$res1['part_name'];?></td>
                                    <td><?=$res1['operation_name'];?></td>
                                    <td><?=$res1['qty_in_kgs'];?></td>
                                    <td><?=$delete_remark[1];?></td>
                                    <td><?=$res1['created_by'].' - '.$res1['createdByName'];?></td>
                                    <td><?=date('d-m-Y h:i a',strtotime($res1['created_on']));?></td>
                                    <td><?=$res1['updated_by'].' - '.$res1['updatedByName'];?></td>
                                    <td><?=date('d-m-Y h:i a',strtotime($res1['updated_on']));?></td> 
                            </tr>
