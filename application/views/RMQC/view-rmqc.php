                ...
                <div class="content__wrap">
                    <div class="card mb-3">
                        <div class="card-body">
                             ...
                             <?php echo form_open('/RMQC', array('autocomplete' => 'off','class' => 'row g-3')); ?>
                                   ...
                                   <h3>Raw Material QC</h3>
                                    ...
                                    <div class="col-md-3">
                                       ...
                                       <input id="date" name="date" type="month" class="form-control" value="<?=$date;?>" min="<?php echo minDate();?>" max="<?php echo maxDate();?>">
                                           ...
                                           <?php $pendingval=(set_value('pendingval'))?set_value('pendingval'):$_SESSION['pendingVal'];?>
                                            <select class="form-control" name="pendingval" id="pendingval">
                                                <option <?= ($pendingval == "pending") ? "selected" : ""; ?> value="pending"> Pending </option>
                                                     <option <?= ($pendingval == "all") ? "selected" : ""; ?> value="all"> All Record</option>
                                            </select>
    ...
    function getChildRow(data)
    {
        ...
        {  
            ...
            $.ajax({
                      ...
                      // dataType : "POST",
                      data:{id:id},
                      url:"<?php echo base_url();?>ViewAddRMQC",
                      dataType:"json",
                      success:function(result){
                        
                        window.location = ('addRMQC?id='+result);
                    }
              });
...
if(pending=="pending")
{
    ...
    function ajaxcall2(all)
    {
         $.ajax({
              ...
              url:"<?php echo base_url();?>GetRMQCData",
              dataType:"json",
              success:function(result){
              var example = $('#example').DataTable({
                            ...
                            "columns" :[
                                       ...
                                       // {"class":"details-control", data:null, defaultContent:""},
                                        ...
                                        { data: "rm_name","title" :"RM Name"},
                                        { data: "supplier_name","title" :"Supplier Name."},
                                        { data: "challan_no","title" :"Challon No"},
        ...
        $.ajax({
              ...
              var example = $('#example').DataTable({
                            ...
                            "columns" :[
                                        ...
                                        { data: "challan_no","title" :"challan_no"},
                                        { data: "challan_date","title" :"challan_date"},
                                         { data: "rm_name","title" :"RM Name"},
                                        { data: "qty","title" :"Qty"},
                                        { data: "rejected_qty","title" :"Rejected Qty"},
                                        { data: "qc_remarks","title" :"QC Remark"},
                                       {data: null, "title" : "Action" ,defaultContent: '<a style="border:none;background-color: transparent;" class="demo-pli-pen-5 fs-5 dt-center fa-hover"></a>'},
            ...
            'td.details-control', function () {
                ...
                if (row.child.isShown()) {
                    ...
                    var id=(row.data().id);
                      ...
                      $.ajax({
                                url:"<?php echo base_url();?>getRmrcirDetail",
                                type: "GET",
                                dataType : "json",
                                 data : {id:id},
